...
import {RedirectCallback} from "@/auth/VueAuth";
import createAuth0Client, {Auth0Client, Auth0ClientOptions} from "@auth0/auth0-spa-js";
import {DEFAULT_REDIRECT_CALLBACK} from "@/main";

let instance : any

export type Auth0Wrapper = {
    loading: boolean,
...
export const useAuth0 = ({
    ...
    instance.init(onRedirectCallback, redirectUri, options as Auth0ClientOptions)
